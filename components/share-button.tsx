  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-11 items-center border border-surface-ivory/30 px-4 font-body text-xs font-bold uppercase tracking-[0.18em] text-surface-ivory hover:border-accent-gold hover:text-accent-gold"
      >
